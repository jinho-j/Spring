package com.first.aaa.service;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

import com.first.aaa.dao.CustomerDeleteData;
import com.first.aaa.dao.CustomerInputData;
import com.first.aaa.dao.CustomerBetaInputData;
import com.first.aaa.dao.CustomerPrintData;
import com.first.aaa.dao.CustomerUpdateData;
...
public class CustomerService implements ICustomerService {
	...
	public String run(String name) {
		...
		CustomerBetaInputData custbetainput = context.getBean(CustomerBetaInputData.class);
		...
		while(true) {
			...
			case 'i':
				...
				custList = (ArrayList<Customer>) custInput.getcustList();
				
					   for(int i=0;i<custList.size();i++)
					   {
					   System.out.println("이름"+custList.get(i).getName());
					   System.out.println("성"+custList.get(i).getGender());
					   }
